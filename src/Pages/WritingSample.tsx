...
const LazyImg = ({ src, alt, caption }: { src: string, alt: string, caption?: string | JSX.Element }) => {
...
<LazyImg src="/blog/figure-1.jpg" alt="The pandemic has worsened inequalities experienced by women" caption="Figure 1. The pandemic has worsened inequalities experienced by women" />
...
<LazyImg src="/blog/women-in-stem-graph.jpg" alt="Percentage of Women in STEM Jobs from 1970-2019"></LazyImg>
